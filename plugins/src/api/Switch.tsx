...
export const MxDoubleSwitch : Component<MxDoubleSwitchProps> = (props) => {
	...
	return (
		<Switch class="flex items-center space-x-2" checked={props.value} onChange={onChange} disabled={props.disabled !== undefined && props.disabled}>
			<SwitchLabel>{props.labelFalse}</SwitchLabel>
			<SwitchControl>
				<SwitchThumb/>
			</SwitchControl>
			<SwitchLabel>{props.labelTrue}</SwitchLabel>
		</Switch>
	);
};
